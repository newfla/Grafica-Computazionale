...
void lightOn(){
    //LIGTH INIT
        ...
        glLightfv(GL_LIGHT1,GL_DIFFUSE,new float[3]{0.33,80./255.,74./255.});
        glLightfv(GL_LIGHT1,GL_SPECULAR,new float[3]{0.7,0.7,0.7});

        glLightfv(GL_LIGHT2,GL_DIFFUSE,new float[3]{0.33,80./255.,74./255.});
        glLightfv(GL_LIGHT2,GL_SPECULAR,new float[3]{0.7,0.7,0.7});

        glLightfv(GL_LIGHT3,GL_DIFFUSE,new float[3]{0.33,80./255.,74./255.});
        glLightfv(GL_LIGHT3,GL_SPECULAR,new float[3]{0.7,0.7,0.7});

        glLightfv(GL_LIGHT4,GL_DIFFUSE,new float[3]{0.33,80./255.,74./255.});
        glLightfv(GL_LIGHT4,GL_SPECULAR,new float[3]{0.7,0.7,0.7});
}
    ...
    //APPLIQUE PARETE SX
        glPushMatrix();
            ...
            glTranslatef(.7,.1,.051);
                glutSolidCube(0.1);
                glLightfv(GL_LIGHT1,GL_POSITION, new float[4]{3,3,3,1});
        glPopMatrix();
        glPushMatrix();
            glScalef(1,1,0.3);
            glTranslatef(-.7,.1,.051);
