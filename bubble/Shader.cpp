...
void ShaderUtility::Shader::setVec3(const std::string name,glm::vec3 value) const{
    glUniform3fv(glGetUniformLocation(id,name.c_str()),1, glm::value_ptr(value));
}


void ShaderUtility::Shader::setMat4(const std::string name,glm::mat4 value) const{
